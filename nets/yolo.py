...
class SPPCSPC(nn.Module):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5, k=(5, 7, 9, 11, 13)):
...
class YoloBody(nn.Module):
    def __init__(self, anchors_mask, num_classes, phi, pretrained=False):
        ...
        self.feat1_attention=attention_block[3](512)
        self.feat2_attention=attention_block[1](1024)
        self.feat3_attention=attention_block[0](1024)
